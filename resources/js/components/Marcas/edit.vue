                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action=" $marca->id " method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="logo">Logo(100x100)</label>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <button id="button" type="submit"  style="border-radius:0;" @click="actualizarMarca()" class="btn btn-primary" disabled >Actualizar Marca</button>
                                                </div>
