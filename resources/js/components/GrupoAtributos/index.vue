                                ...
                                <div class="card-body">
                                    <table id="myTable" class="table table-striped table-hover" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="cursor: pointer;" @click="abrirFormularioGrupoAtributo('grupoatributo','atributo',grupoatributo)" v-for="grupoatributo in arrayGrupoAtributo" :key="grupoatributo.id">
                                                    ...
                                                    &nbsp;
                                                        <button type="button" @click="abrirFormularioGrupoAtributo('grupoatributo','actualizar',grupoatributo)" class="btn btn-warning btn-sm">
                                                            <i class="fas fa-pencil-alt" style="color:#fff"></i>
                                                        </button>&nbsp;
                                                        <button type="button" @click="abrirFormularioGrupoAtributo('grupoatributo','eliminar',grupoatributo)" class="btn btn-danger btn-sm">
                                                            <i class="fas fa-trash-alt" style="color:#fff"></i>
                                                        </button>&nbsp;
                                                        <button type="button" @click="abrirFormularioGrupoAtributo('grupoatributo','atributo',grupoatributo)" class="btn btn-primary btn-sm">
                    ...
                    <!-- Listado Atributo -->
                        ...
                        <!-- Ejemplo de tabla Listado -->
                            <div style="padding: 0px 0px 18px; font-family: 'Rubik', sans-serif;">
                                <button type="button" @click="abrirFormularioAtributo('atributo','registrar')"  class="btn btn-success button-registrar" style="border-radius:0;">
                                        ...
                                        <!-- <tr >
                                            ...
                                            <tr  style="cursor: pointer;" v-for="atributo in arrayAtributo" :key="atributo.id">
                                                ...
                                                <td class="widthOpcionesAtributo" style="padding: 10px 0px 0px;"> 
                                                    &nbsp;
                                                    <button type="button" @click="abrirFormularioAtributo('atributo','actualizar',atributo)" class="btn btn-warning btn-sm">
                                                        <i class="fas fa-pencil-alt" style="color:#fff"></i>
                                                    </button>&nbsp;
                                                    <button type="button" @click="abrirFormularioAtributo('atributo','eliminar',atributo)" class="btn btn-danger btn-sm">
                                                        <i class="fas fa-trash-alt" style="color:#fff"></i>
                                                    </button>&nbsp;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form  @submit.prevent="NuevoFormularioNuevoAtributo()" method="POST" enctype="multipart/form-data">
                                                    
                                                    <div  class="form-group">
                                                        <label for="grupo">atributo</label>
                                                        <input type="text" v-model="atributo" id="grupo"  style="border-radius:0;" class="form-control" placeholder="grupo">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="gruposatributo_id" >Grupo Atributo</label>
                                                        <input type="number" v-model="gruposatributo_id" style="border-radius:0;" class="form-control" placeholder="orden" readonly>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <a type="button"  style="border-radius:0;" @click="CerrarAñadirAtributo()" class="btn btn-secondary">Cerrar</a>
                                                            <button id="button" type="submit"  style="border-radius:0;" class="btn btn-primary"  >Registrar Atributo</button>
                                                        </div>
        ...
        export default {
            ...
            methods : {
                ...
                abrirFormularioGrupoAtributo(modelo, accion, data = []){
                    switch(modelo){
                        case "grupoatributo":
                        {
                            switch(accion){
                ...
                abrirFormularioAtributo(modelo, accion, data = []){
                    switch(modelo){
                        case "atributo":
                        {
                            switch(accion){
